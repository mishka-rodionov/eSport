...
sealed class WorkoutEditorAction : BaseAction {
    ...
    data class ChangeDurationHours(val value: String) : WorkoutEditorAction()
    data class ChangeDurationMinutes(val value: String) : WorkoutEditorAction()
    data class ChangeDurationSeconds(val value: String) : WorkoutEditorAction()
